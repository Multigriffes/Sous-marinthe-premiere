...
def creation_grille_joueur(taille_grille:int,pos_joueur:list=[]):
    ...
    if pos_joueur == [] :
        ...
        assert len(pos_joueur) == 2 , "Y a 2 nombres pour une coordonnees en 2D idiots"
...
def play():
    ...
    pos_joueur=list(input("Position du joueur : "))
    ...
    while isPlay:
        ...
        commande=""
        while commande=="":
            commande=str(input("Action souhaitee : "))
